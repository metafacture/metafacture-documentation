...
The content for `flux-commands.md` is automatically generated by running the Metafacture runner with the `-l`/`--list-commands` option, the output needs to be copied to [docs/flux/flux-commands.md](https://github.com/metafacture/metafacture-documentation/blob/master/docs/flux/flux-commands.md).
...
- Run the runner in this directory with the `-l`/`--list-commands` option: `./metafacture-core/flux.sh -l` (note that the links will only be generated if the Git repository `metafacture-documentation` is checked out and the file [`linksAndExamples.tsv`](https://github.com/metafacture/metafacture-documentation/blob/master/linksAndExamples.tsv) is accessible).
